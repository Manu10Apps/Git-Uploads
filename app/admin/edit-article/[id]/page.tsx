      ...
      try {
        ...
        if (articleData.success) {
          ...
          setForm({
            ...
            authorSocialPlatform: article.authorSocialPlatform || '',
            authorSocialUrl: article.authorSocialUrl || '',
            authorSocialPlatform2: article.authorSocialPlatform2 || '',
            authorSocialUrl2: article.authorSocialUrl2 || '',
            image: article.image,
          ...
          await syncAuthorSocialProfile(article.author);
        } else {
